...
//
    ...
    void vne_second_derivative_00_11(
        double ae, double be,
        ...
        std::size_t Ai, std::size_t Bi)
    {
        ...
        const double d2nexx000000 = ( 2 * Pi * ( C124 - ( C68 * ( C59 - ( C67 * C95)  / C64)  * C79)  / C64 + C124 + ( C59 * ( std::pow(C94, 2) * C69 * C88 - C89)  * C70)  / C81)  * C60 * C61)  / C64;
        d2nexx[ (Ai + 0)*matrix_size + Bi +0] += d2nexx000000;
        const double d2nexy000000 = ( 2 * Pi * ( ( C125 * C95)  / C64 + ( ( 2 * C106 * C97)  / C64 + ( C61 * C88 * C69 * C94 * C96 * C70)  / C81)  * C59)  * C60)  / C64;
        d2nexy[ (Ai + 0)*matrix_size + Bi +0] += d2nexy000000;
        const double d2nexz000000 = ( 2 * Pi * ( ( C126 * C95)  / C64 + ( ( 2 * C106 * C99)  / C64 + ( C60 * C88 * C69 * C94 * C98 * C70)  / C81)  * C59)  * C61)  / C64;
        d2nexz[ (Ai + 0)*matrix_size + Bi +0] += d2nexz000000;
        const double d2neyx000000 = ( 2 * Pi * ( ( C127 * C97)  / C64 + ( ( 2 * C107 * C95)  / C64 + ( C59 * C88 * C69 * C96 * C94 * C70)  / C81)  * C61)  * C60)  / C64;
        d2neyx[ (Ai + 0)*matrix_size + Bi +0] += d2neyx000000;
        const double d2neyy000000 = ( 2 * Pi * ( C128 - ( C68 * ( C61 - ( C73 * C97)  / C64)  * C79)  / C64 + C128 + ( C61 * ( std::pow(C96, 2) * C69 * C88 - C89)  * C70)  / C81)  * C59 * C60)  / C64;
        d2neyy[ (Ai + 0)*matrix_size + Bi +0] += d2neyy000000;
        const double d2neyz000000 = ( 2 * Pi * ( ( C126 * C97)  / C64 + ( ( 2 * C107 * C99)  / C64 + ( C60 * C88 * C69 * C96 * C98 * C70)  / C81)  * C61)  * C59)  / C64;
        d2neyz[ (Ai + 0)*matrix_size + Bi +0] += d2neyz000000;
        const double d2nezx000000 = ( 2 * Pi * ( ( C127 * C99)  / C64 + ( ( 2 * C109 * C95)  / C64 + ( C59 * C88 * C69 * C98 * C94 * C70)  / C81)  * C60)  * C61)  / C64;
        d2nezx[ (Ai + 0)*matrix_size + Bi +0] += d2nezx000000;
        const double d2nezy000000 = ( 2 * Pi * ( ( C125 * C99)  / C64 + ( ( 2 * C109 * C97)  / C64 + ( C61 * C88 * C69 * C98 * C96 * C70)  / C81)  * C60)  * C59)  / C64;
        d2nezy[ (Ai + 0)*matrix_size + Bi +0] += d2nezy000000;
        const double d2nezz000000 = ( 2 * Pi * ( C129 - ( C68 * ( C60 - ( C76 * C99)  / C64)  * C79)  / C64 + C129 + ( C60 * ( std::pow(C98, 2) * C69 * C88 - C89)  * C70)  / C81)  * C61 * C59)  / C64;
